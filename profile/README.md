...
- a modern development workflow via [Visual Studio Code](https://code.visualstudio.com/) using customized extensions (Lua Language Server, Local Lua Debugger). These extensions can be installed from `.vsix` files found under `<INSTALL_PATH>/opt/vscode`,
- an easy entry into the Lua world by providing the [ZeroBrane Studio](https://github.com/pkulchenko/ZeroBraneStudio) Integrated Development Environment (IDE) and the [luacheck](https://github.com/OneLuaPro/luacheck) linter for static code analysis.
...
First, install **OneLuaPro**. Then, install all provided extensions either from [VSCode Marketplace](https://marketplace.visualstudio.com/search?term=oneluapro&target=VSCode&category=All%20categories&sortBy=Relevance) or from `<INSTALL_PATH>\opt\vscode`. These code-signed extensions are pre-configured and require no further adjustment.

<p align="center">
  <img src="./assets/olp-vscode-integration.png" alt="OneLuaPro VSCode Integration">
</p>
...
| --------------------------------------------------- | ------------------------------------------------------------ | --------------------- | ------------------------------------------------------------ |
| [Lua](https://github.com/KritzelKratzel/lua)        | The Lua 5.5 Programming Language                             | `v5.5.0-5-g4154493`   | [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) |
...
| [Penlight](https://github.com/OneLuaPro/Penlight)   | Inspired by the Python standard library, this suite of pure Lua tools provides robust utilities for input data handling, functional programming, and OS path management. | `v1.15.0-19-g9ece351` | [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) |
...
| Extension                                                   | Purpose                                                      | Version                | License                                                      |
| ----------------------------------------------------------- | ------------------------------------------------------------ | ---------------------- | ------------------------------------------------------------ |
| [wxLanesBridge](https://github.com/OneLuaPro/wxlanesbridge) | A module providing thread-safe communication between [wxLua](https://github.com/OneLuaPro/wxlua) and [Lanes](https://github.com/OneLuaPro/lanes) via a custom C++ bridge for asynchronous GUI updates | `v1.0.1`               | [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) |
| [wxLua](https://github.com/OneLuaPro/wxlua)                 | wxLua is a Lua wrapper for the cross-platform [wxWidgets](https://github.com/wxWidgets/wxWidgets) GUI library | `v3.2.0.2-18-gc5e0cbb` | [![License: LGPL v3](https://img.shields.io/badge/License-LGPL_v3-blue.svg)](https://www.gnu.org/licenses/lgpl-3.0) |
...
| [lua-ffi](https://github.com/OneLuaPro/lua-ffi)             | A portable lightweight C foreign function interface (FFI) for Lua, based on [libffi](https://github.com/OneLuaPro/libffi) | `v1.1.0-31-ga8ae836`    | [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) |
...
| Extension                                     | Purpose                                                      | Version  | License                                                      |
| --------------------------------------------- | ------------------------------------------------------------ | -------- | ------------------------------------------------------------ |
| [distro](https://github.com/OneLuaPro/distro) | OneLuaPro Distro Information and Distribution Integrity Checker | `v2.1.0` | [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) |

### 🌐 Networking & Security

| Extension                                               | Purpose                                                | Version                | License                                                      |
| ------------------------------------------------------- | ------------------------------------------------------ | ---------------------- | ------------------------------------------------------------ |
| [Lua-cURLv3](https://github.com/OneLuaPro/Lua-cURLv3)   | Lua binding to [libcurl](https://github.com/curl/curl) | `v0.3.13-6-gbd885bd`   | [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) |
| [lua-openssl](https://github.com/OneLuaPro/lua-openssl) | [OpenSSL](https://www.libressl.org/) bindings for Lua  | `0.11.0-3-25-gd068708` | [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) |
...
| Extension                                     | Purpose                                                | Version              | License                                                      |
| --------------------------------------------- | ------------------------------------------------------ | -------------------- | ------------------------------------------------------------ |
| [luaCOM](https://github.com/OneLuaPro/luacom) | Microsoft Component Object Model (COM) binding for Lua | `v1.4.1-93-g16aebd4` | [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) |
...
| Extension                                                    | Purpose                                                      | Version              | License                                                      |
| ------------------------------------------------------------ | ------------------------------------------------------------ | -------------------- | ------------------------------------------------------------ |
| [DistroCheck](https://github.com/OneLuaPro/distro)           | Distribution Integrity Checker                               | `v2.1.0`             | [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) |
